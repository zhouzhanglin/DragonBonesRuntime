...
namespace DragonBones
{
    ...
    public class DBIcons : Editor {
        ...
        static void Initialize(){
            ...
            FileInfo[] files = rootDir.GetFiles("DBIcons.cs", SearchOption.AllDirectories); 
...
//            textureIk = AssetDatabase.LoadAssetAtPath<Texture2D>(editorGUIPath+"/icon-ik.png");
        ...
        static void HierarchyIconsOnGUI (int instanceId, Rect selectionRect) {
            ...
            if(go.GetComponent<UArmatureComponent>())
            {
            ...
            UUGUIDisplay ugui = go.GetComponent<UUGUIDisplay>();
            ...
            if(mf && mf.sharedMesh && 
                ...
                mf.transform.parent.parent.GetComponent<UArmatureComponent>()!=null)
            {
            ...
            UBone ubone = go.GetComponent<UBone>();
            if(ubone){
