...
namespace DragonBones
{
    public class USlot : Slot
    {
        ...
        internal UUGUIDisplay _uiDisplay = null;

        internal UMeshBuffer _meshBuffer;
        ...
        internal UCombineMeshs _combineMesh = null;
        internal bool _isActive = false;

        private bool _skewed;
        private UArmatureComponent _proxy;
        ...
        protected override void _DisposeDisplay(object value, bool isRelease)
        {
            if (!isRelease)
            {
                UFactoryHelper.DestroyUnityObject(value as GameObject);
            }
        }
        /**
         * @private
        ...
        protected override void _OnUpdateDisplay()
        {
            ...
            //
            _proxy = _armature.proxy as UArmatureComponent;
            if (_proxy._isUGUI)
            {
                _uiDisplay = _renderDisplay.GetComponent<UUGUIDisplay>();
                if (_uiDisplay == null)
                {
                    _uiDisplay = _renderDisplay.AddComponent<UUGUIDisplay>();
            ...
            if (this._meshBuffer == null)
            {
                this._meshBuffer = new UMeshBuffer();
                this._meshBuffer.sharedMesh = UMeshBuffer.GenerateMesh();
...

            {
                ...
                if (_renderDisplay != null)
                {
                    ...
                    if (_childArmature == null)
                    {
                        ...
                        if (_proxy.sortingMode == DBSortingMode.SortByOrder)
                        {
                            _meshRenderer.sortingOrder = _zOrder * UArmatureComponent.ORDER_SPACE;
                        }
                        else
                        {
                    ...
                    {
                        var childArmatureComp = childArmature.proxy as UArmatureComponent;
                        childArmatureComp._sortingMode = _proxy._sortingMode;
                        childArmatureComp._sortingLayerName = _proxy._sortingLayerName;
                        if (_proxy._sortingMode == DBSortingMode.SortByOrder)
                        {
                            childArmatureComp.sortingOrder = _zOrder * UArmatureComponent.ORDER_SPACE;
                        }
                        else
                        {
        ...
        private void _CombineMesh()
        {
            ...
            //已经关闭合并，不再考虑
            if (this._isIgnoreCombineMesh || this._proxy._isUGUI)
            {
                return;
            }
            ...
            var combineMeshComp = this._proxy.GetComponent<UCombineMeshs>();
            //从来没有合并过，触发合并，那么尝试合并
        ...
        internal override void _UpdateBlendMode()
        {
            ...
            if (this._childArmature == null)
            {
                ...
                {
                    this._uiDisplay.material = (this._textureData as UTextureData).GetMaterial(this._blendMode, true);
                }
                else
                {
                    this._meshRenderer.sharedMaterial = (this._textureData as UTextureData).GetMaterial(this._blendMode);
                }
        ...
        protected override void _UpdateColor()
        {
            ...
            else
            {
                ...
                (this._childArmature.proxy as UArmatureComponent).color = _colorTransform;
            }
        ...
        protected override void _UpdateFrame()
        {
            ...
            var currentTextureData = this._textureData as UTextureData;

            this._meshBuffer.Clear();
            this._isActive = false;
            if (this._displayIndex >= 0 && this._display != null && currentTextureData != null)
            {
                var currentTextureAtlas = _proxy._isUGUI ? currentTextureAtlasData.uiTexture : currentTextureAtlasData.texture;
        ...
        public UTextureAtlasData currentTextureAtlasData
        {
            get
            {
                ...
                return this._textureData.parent as UTextureAtlasData;
            }
        }
        ...
        public UArmatureComponent proxy
        {
